...
//precio filtros//
$pr_asc  =ant_price_asc($connect);
$pr_desc =ant_price_desc($connect);

//quantity filtros//
$quan_asd=ant_quantity_asc($connect);
$quan_desc=ant_quantity_desc($connect);
...
<thead>
            <tr>
                ...
                <th>Price 
                    <small>
                        <form action= "../antwone/indexa.php" method="post">
